...
// Hash: 5a83ee07d98cb2c381aa0acf37d20e3bad3acf947d2bcb26ff8d96502e253d41
package prototype
...
func (b *Block) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o9:]
		num, err := ssz.DecodeDynamicLength(buf, 600)
		if err != nil {
			return err
		}
...
func (b *Block) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (9) 'Transactions'
	{
		...
		hh.MerkleizeWithMixin(subIndx, num, 600)
	}
...
func (t *Transaction) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o6:o7]
		num, err := ssz.DivideInt2(len(buf), 64, 1000)
		if err != nil {
			return err
		}
